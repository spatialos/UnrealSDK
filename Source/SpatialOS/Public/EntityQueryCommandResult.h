...
class SPATIALOS_API UEntityQueryCommandResultBase : public UObject
{
  GENERATED_BODY()
...
class SPATIALOS_API UEntityQueryCountCommandResult : public UEntityQueryCommandResultBase
{
  GENERATED_BODY()
...
*/
UCLASS(BlueprintType)
class SPATIALOS_API UEntityQuerySnapshotCommandResult : public UEntityQueryCommandResultBase
{
  GENERATED_BODY()

...
* The Components list allows the newly-constructed connection to
* serialize and deserialize components that exist in the game's module.
*/
  FWorkerConnection();
...
* creation is made or the timeout is reached */
  ...
  void Disconnect();
  /** Process any ops that have been dispatched from the SpatialOS
* connection. */
  void ProcessOps();

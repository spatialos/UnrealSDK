...
struct SPATIALOS_API FSOSNetworkingConfiguration
{
  GENERATED_USTRUCT_BODY()

  FSOSNetworkingConfiguration()
...
*/
USTRUCT(BlueprintType)
struct SPATIALOS_API FSOSWorkerConfigurationData
{
  GENERATED_USTRUCT_BODY()

  FSOSWorkerConfigurationData() : Debugging(), Networking(), SpatialOSApplication()
  {
  }
  ...
  */
  UPROPERTY(EditAnywhere, config, Category = WorkerConfiguration)
  FSOSNetworkingConfiguration Networking;

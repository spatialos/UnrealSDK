...
public:
  ...
  // clang-format on
  void ApplyConfiguration(const FSOSWorkerConfigurationData& InWorkerConfigurationData);
  ...
  */
   ...
   */
  UFUNCTION(BlueprintCallable, Category = "SpatialOS")
  const FSOSWorkerConfiguration GetWorkerConfiguration() const;
  ...
  * Entity pipeline
  */
  UEntityPipeline* GetEntityPipeline();
...
private:
  UPROPERTY()
  FSOSWorkerConfiguration WorkerConfiguration;
